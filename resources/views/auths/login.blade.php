...
<head>
	...
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('admin/assetsKLO/img/apple-icon.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('admin/assetsKLO/img/favicon.png')}}">
</head>
				...
				<div class="auth-box ">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Sistem Kependudukan </h1>
							<p>Dusun Sarangan, Desa Kendalpayak</p>
						</div>
					</div>
